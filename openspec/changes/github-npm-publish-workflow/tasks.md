...
- [x] 2.3 Configure npm registry authentication using `secrets.NPM_TOKEN` and publish to `https://registry.npmjs.org` without committing credentials.
...
- [x] 3.2 Document required repository secret setup for `NPM_TOKEN`.
