  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={cn(
          'appearance-none min-w-0 flex-1 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-slate-500 focus:ring-1 focus:ring-slate-300 disabled:cursor-not-allowed disabled:bg-slate-100',
          classNames?.input,
        )}
        value={draft}
